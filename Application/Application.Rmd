...
`lopm.CalibSet` and `lopm.Fr` datasets were slightly disturbed in
order to comply with diffusion constrains.
...
```{r,echo=T}
SIR.compare<-SIR%>%mutate(Method="glmer")%>%
  bind_rows(SIR.PQL%>%mutate(Method="glmmPQL"))
